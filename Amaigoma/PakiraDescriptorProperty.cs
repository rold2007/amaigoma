namespace Amaigoma
{
   ...
   public class PakiraDescriptorProperty
   {
      ...
      internal PakiraDescriptorProperty(PakiraDescriptor descriptor, string name, bool label)
      {
         _label = label;
         _name = name;
      ...
      public PakiraDescriptor Use(Func<object, double> conversion)
      {
      ...
      public PakiraDescriptor As(Type type)
      {
         Property p;
         if (_label)
      ...
      /// <returns>descriptor with added property</returns>
      public PakiraDescriptor As(Property property)
      {
         property.Name = _name;
      ...
      /// </summary>
      /// <returns>descriptor with added property.</returns>
      public PakiraDescriptor AsString()
      {
      ...
      /// <returns>descriptor with added property.</returns>
      public PakiraDescriptor AsString(StringSplitType splitType, string separator = " ", string exclusions = null)
      {
         StringProperty p = new StringProperty();
         p.Name = _name;
      ...
      /// </summary>
      /// <returns>Descriptor.</returns>
      public PakiraDescriptor AsCharEnum()
      {
         StringProperty p = new StringProperty();
         p.Name = _name;
         p.AsEnum = true;
      ...
      /// <summary>Adds string property to descriptor with previously chained name.</summary>
      /// <returns>descriptor with added property.</returns>
      public PakiraDescriptor AsStringEnum()
      {
         StringProperty p = new StringProperty();
         p.Name = _name;
         p.AsEnum = true;
      ...
      /// <returns>descriptor with added property.</returns>
      public PakiraDescriptor AsGuid()
      {
      ...
      /// <returns>descriptor with added property.</returns>
      public PakiraDescriptor AsDateTime(DateTimeFeature features)
      {
         if (_label)
      ...
      /// DateTimeFeature.DayOfWeek)</param>
      /// <returns>descriptor with added property.</returns>
      public PakiraDescriptor AsDateTime(DatePortion portion)
      {
         if (_label)
      ...
      /// <returns>descriptor with added property.</returns>
      public PakiraDescriptor AsEnumerable(int length)
      {
         if (_label)
